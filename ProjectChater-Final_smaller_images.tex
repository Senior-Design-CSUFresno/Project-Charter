...
\begin{figure}[H]
	\centering
	{\includegraphics[max size={\textwidth}{\textheight}, scale=0.60]{"systemDiagram".png}}
...
\begin{figure}[H]
	\centering
	{\includegraphics[max size={\textwidth}{\textheight}, scale=0.90]{"LM".png}}
...
\begin{figure}[H]
	\centering
	{\includegraphics[max size={\textwidth}{\textheight}, scale=0.35]{"teeth".jpg}}
...
\begin{figure}[H]
	\centering
	{\includegraphics[max size={\textwidth}{\textheight}, scale=0.55]{"pulley".jpg}}
